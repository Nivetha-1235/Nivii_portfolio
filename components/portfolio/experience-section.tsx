...
const experiences = [
  {
    ...
    description: 'Independently built and maintained production-grade database solutions for the Vacation Management System (VMS), an enterprise leave management platform serving 500+ employee records across departments.',
    responsibilities: [
      'Built 20+ stored procedures, views & complex T-SQL queries powering the VMS application',
      'Optimised 10+ slow-running queries via indexing strategies & execution plan analysis, cutting response time ~40%',
      'Owned end-to-end ETL pipelines — extract, transform, load across modules with full data integrity',
      'Developed 5+ SSRS reports consumed by HR teams for real-time leave visibility & compliance',
      'Performed SQL debugging & root-cause analysis of production data discrepancies',
      'Collaborated directly with senior developers and project leads using agile workflows',
    ],
    tags: ['T-SQL', 'SSMS', 'ETL', 'SSRS', 'Stored Procedures', 'Indexing', 'SQL Server'],
    link: 'https://www.photon.com',
    color: 'from-blue-500 to-cyan-500',
  },
  {
    company: 'Varutech Solutions Pvt Ltd',
    role: 'MySQL Intern',
    duration: 'Jan 2024 – Feb 2024',
    location: 'Chennai, India',
    description: 'Designed normalised relational database schemas for business modules and wrote complex SQL queries for reporting and documentation.',
    responsibilities: [
      'Designed 3NF schemas for 3 business modules, reducing data redundancy',
      'Wrote CRUD operations with complex JOINs and subqueries for business reporting',
      'Documented data dictionaries and ER diagrams for team knowledge sharing',
    ],
    tags: ['MySQL', 'SQL', 'Schema Design', 'ER Diagrams', 'CRUD'],
    link: null,
